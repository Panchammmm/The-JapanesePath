...
export default function ContactPage() {
  ...
  return (
    <section className="relative overflow-hidden min-h-screen bg-japan-warm">

      <div className="absolute inset-0 z-0">
        {/* Pattern Overlay */}
        <div className="absolute inset-0 opacity-[0.04]" style={{ backgroundImage: "url(\"data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23c41e3a' fill-opacity='1'%3E%3Cpath d='M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E\")" }} />
      </div>

      {/* Content - Add relative z-index to appear above background */}
      <div className="relative z-10">
        ...
        <section className="py-10 md:py-14 mb-12">
          <div className="max-w-2xl mx-auto px-4 md:px-8">
            <div className="rounded-2xl p-8 md:p-12 border-2 border-border shadow-lg bg-card">
              ...
              <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    className={`w-full px-4 py-3 rounded-lg border-2 transition-all duration-200 outline-none cursor-pointer bg-background text-foreground ${errors.contactType ? 'border-destructive' : 'border-input'
                      }`}
                  >
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 rounded-lg border-2 transition-all duration-200 outline-none bg-background text-foreground placeholder:text-muted-foreground ${errors.fullName ? 'border-destructive' : 'border-input'
                      }`}
                  />
                  {errors.fullName && (
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    disabled={isSubmitting}
                    className={`w-full px-4 py-3 rounded-lg border-2 transition-all duration-200 outline-none bg-background text-foreground placeholder:text-muted-foreground ${errors.email ? 'border-destructive' : 'border-input'
                      }`}
                  />
                  {errors.email && (
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    disabled={isSubmitting}
                    className={`w-full px-4 py-3 rounded-lg border-2 transition-all duration-200 outline-none bg-background text-foreground placeholder:text-muted-foreground ${errors.phone ? 'border-destructive' : 'border-input'
                      }`}
                  />
                  {errors.phone && (
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    disabled={isSubmitting}
                    className={`w-full px-4 py-3 rounded-lg border-2 transition-all duration-200 outline-none bg-background text-foreground placeholder:text-muted-foreground ${errors.subject ? 'border-destructive' : 'border-input'
                      }`}
                  />
                  {errors.subject && (
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    disabled={isSubmitting}
                    className={`w-full px-4 py-3 rounded-lg border-2 transition-all duration-200 outline-none resize-y bg-background text-foreground placeholder:text-muted-foreground ${errors.message ? 'border-destructive' : 'border-input'
                      }`}
                  />
                  {errors.message && (
                ...
                {status.type !== 'idle' && (
                  <div
                    className={`p-4 rounded-lg border-2 flex items-start gap-3 animate-in fade-in ${status.type === 'success'
                  ...
                  >
                    ...
                    <p
                      className={`text-sm leading-relaxed ${status.type === 'success'
