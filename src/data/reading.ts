...
export const reading: Record<string, ReadingPassage[]> = {
  ...
  n2: [
    {
      title: "働き方改革",
      passage: "日本では近年、働き方改革が進んでいます。長時間労働の見直しやリモートワークの導入など、様々な取り組みが行われています。しかし、全ての企業が対応できているわけではありません。",
      furiganaPassage: "日本（にほん）では近年（きんねん）、働（はたら）き方（かた）改革（かいかく）が進（すす）んでいます。長時間（ちょうじかん）労働（ろうどう）の見直（みなお）しやリモートワークの導入（どうにゅう）など、様々（さまざま）な取（と）り組（く）みが行（おこな）われています。しかし、全（すべ）ての企業（きぎょう）が対応（たいおう）できているわけではありません。",
      vocabHighlights: ["改革", "労働", "導入"],
      questions: [
        {
          question: "What is being reformed in Japan?",
          options: ["Education", "Work style", "Healthcare", "Transportation"],
          answer: 1,
        },
      ],
    },
